...
const Contact = () => {
  return (
    <Layout title={"Contact Us - Online Bazaar"}>
      <div class='py-4 bg-[#1A2238] text-white' style={{ height: "100vh" }}>
        <div class='container mx-auto flex flex-col md:flex-row my-12 md:my-36'>
          <div class='flex flex-col w-full lg:w-2/5 p-8'>
            ...
            <p class='font-sans text-sm md:text-lg my-2 md:my-4'>
              ...
              Online Bazaar Head Office, Mumbai
            </p>
            <p class='font-sans text-sm md:text-lg my-2 md:my-4'>
              <svg
                class='inline-block fill-current mr-2'
              ...
              onlinebazaar@gmail.com
            </p>
            <p class='font-sans text-sm md:text-lg my-2 md:my-4 pb-5'>
              <svg
                class='inline-block fill-current mr-2'
                xmlns='http://www.w3.org/2000/svg'
                width='24'

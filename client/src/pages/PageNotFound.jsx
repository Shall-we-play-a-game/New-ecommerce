...
const PageNotFound = () => {
  return (
    <Layout title={"ERROR - Online Bazaar"}>
      <main className='flex h-screen w-full flex-col items-center justify-center bg-[#1A2238]'>
        ...
        <button className='mt-5'>
          <NavLink className='group relative inline-block text-sm font-medium text-[#FF6A3D] focus:outline-none focus:ring active:text-orange-500'>
